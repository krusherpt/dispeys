...
4. If confirmed, run:
   ```bash
   /home/nyankopc/.npm/_npx/1905fdeacf10eade/node_modules/.bin/caliber learn add "<refined learning>"
   ```
   For personal preferences (not project-level), add `--personal`:
   ```bash
   /home/nyankopc/.npm/_npx/1905fdeacf10eade/node_modules/.bin/caliber learn add --personal "<refined learning>"
   ```
...
-> If yes: run `/home/nyankopc/.npm/_npx/1905fdeacf10eade/node_modules/.bin/caliber learn add "**[convention]** Push feature commits to the next branch, not master"`
